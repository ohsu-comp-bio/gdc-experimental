  ...
  return (
    <li className="dropdown nav-item">
        ...
        <ul className="dropdown-menu" style={{right:0, left: 'auto'}}>
          ...
          <a className="dropdown-item" href="https://github.com/ohsu-computational-biology/gdc-experimental"target="_blank" title="View on Github"><i className="fa fa-github" style={{marginRight: '0.5em'}}/>Github</a>
        </ul>
    </li>
  );
}
