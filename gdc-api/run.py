...
def projects():
    ...
    return _makeCCCFakeResponse('project')
...
def cases():
    """Search & Retrieval Find all files related to a specific case,
     or sample donor."""
    return _makeCCCFakeResponse('case')
...
def _makeCCCFakeResponse(schema_key):
    """ create a response object with random data based on jsonschema
    currently the schema_key values are:
    []]
    """
    return _callFaker(json.dumps(cccschema.json_schema('schema_key')))


def _makeGDCFakeResponse(schema_key):
    """ create a response object with random data based on jsonschema
    currently the schema_key values are:
