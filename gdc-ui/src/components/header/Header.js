          ...
          <div className="container-fluid">
            ...
            <div id="collapsingNavbar" className="collapse navbar-toggleable-xs">
              ...
              <ul className="nav navbar-nav">
                <li title="Github Users with over 1000 Followers" className={isUsersPage ? 'nav-item active' : 'nav-item'}><Link className="nav-link" to="/users">Popular</Link></li>
                <li title="Github Repos with over 10000 Stars" className={isReposPage ? 'nav-item active' : 'nav-item'}><Link className="nav-link" to="/repos">Productive</Link></li>
